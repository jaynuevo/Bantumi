...
public class AIdrop extends Thread{
	...
	public AIdrop(int moves, int next, int position, Test test){
		this.moves = moves;
		this.next = next;
		this.test = test;
	...
	public synchronized void run(){
		...
		try{
			...
			if (prev == 0 && next<6){
				...
				if(Game.p1Bowl[0] == 0 && Game.p1Bowl[1] == 0 && Game.p1Bowl[2] == 0 && Game.p1Bowl[3] == 0 && Game.p1Bowl[4] == 0 && Game.p1Bowl[5] == 0){
				...
				else if(Game.p2Bowl[0] == 0 && Game.p2Bowl[1] == 0 && Game.p2Bowl[2] == 0 && Game.p2Bowl[3] == 0 && Game.p2Bowl[4] == 0 && Game.p2Bowl[5] == 0){
					Win.yField.setText(Integer.toString(Game.p1Bowl[6]));
					Win.oField.setText(Integer.toString(Game.p2Bowl[6]));
